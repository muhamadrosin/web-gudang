...
//Kirimkan Variabel
 ...
 include "koneksi.php";
	...
	$cek=mysql_num_rows (mysql_query("SELECT code FROM serah_terima_barang WHERE code='$_POST[code]'"));
	if ($cek > 0) {
	?>
			<script language="JavaScript">
			alert('CODE sudah dipakai !, silahkan diulang kembali');
			document.location='home2.php?page=lihat-serahterima2';
			</script>
	<?php
	}
 if(!empty($code)){

	$input	="INSERT INTO serah_terima_barang (tanggal, code, nama, jumlah, satuan,status)
   ...
   document.location='form_serah_terima_barang.php?page=form_serah_terima_barang';
