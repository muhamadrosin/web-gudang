...
<script type="text/javascript"> 
      $(document).ready(function(){
		...
		<form action="input-kirim-barang.php" method="POST" name="form-barang-kirim" enctype="multipart/form-data">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="36">&nbsp;</td>
					<td>&nbsp;</td>
					<td><font size="4"><b>INPUT BARANG KIRIM</b></font></td>
				</tr>
				<tr>
   			...
   			<tr>
				...
				<tr>
					...
					<td><input type="submit" name="submit" value="Tambah Input Barang Kirim">&nbsp;&nbsp;&nbsp;
