...
<?php
 include "koneksi.php";
	...
	$min_tanggal=mysql_fetch_array(mysql_query("select min(tgl_sj) as min_tanggal from barang_masuk"));
	$max_tanggal=mysql_fetch_array(mysql_query("select max(tgl_sj) as max_tanggal from barang_masuk"));
?>
<form action="home3.php?page=lihat-barang-masuk2" method="post" name="postform">
...
<?php
	...
	<script language="JavaScript">
		...
		document.location='home3.php?page=lihat-barang-masuk2';
	</script>
	<?php
	}else{
	?><i><b>Informasi : </b> Hasil pencarian data barang masuk dari Tanggal <b><?php echo $_POST['tanggal_awal']?></b> s/d <b><?php echo $_POST['tanggal_akhir']?></b></i>
	<?php
	$query=mysql_query("select * from barang_masuk where tgl_sj between '$tanggal_awal' and '$tanggal_akhir'");
	}
?>
</p>
<table width="1058" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr bgcolor="#FF6600">
		...
		<th width="180">Jumlah Barang Masuk</td>&nbsp;
...
<?php
    ...
    <tr>
		...
		<td align="center"><?php echo $row['tgl_sj'];?></td>
