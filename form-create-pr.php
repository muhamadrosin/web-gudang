...
<script type="text/javascript"> 
      $(document).ready(function(){
		...
		<form action="input-pr.php" method="POST" name="form-create-pr" enctype="multipart/form-data">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td height="36">&nbsp;</td>
					<td>&nbsp;</td>
					<td><font size="4"><b>INPUT BARANG KELUAR</b></font></td>
				</tr>
				<tr>
				...
				<td><input required type="text" name="tgl_pr" value="" size="10" class="span9" id="tgl_pr" /></td>
			</tr>
      				<tr>
				<td height="36">&nbsp;</td>
				<td>Kode Barang</td>
   			...
   			<tr>
				...
				<tr>
					<td height="36">&nbsp;</td>
					<td>Satuan</td>
					<td><input type="text" name="satuan" size="5"></td>
				</tr>
				<tr>
					<td height="72">&nbsp;</td>
					<td>&nbsp;</td>

					<td><input type="submit" name="submit" value="Tambah Input Barang Keluar">&nbsp;&nbsp;&nbsp;
						<input type="reset" name="reset" value="Reset"></td>
				</tr>
    <tr>
					<td height="36">&nbsp;</td>
     <td height="36">&nbsp;</td>
					<td><a href='aksi_selesai2.php'><h3>SELESAI</h3></a></td>
