...
<div class="content">
	<form action="input-data-permintaan.php" method="POST" enctype="multipart/form-data">
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td height="36">&nbsp;</td>
				<td>&nbsp;</td>
				<td><font size="4"><b>INPUT DATA PERMINTAAN BARANG</b></font></td>
			</tr>
			<tr>
          ...
          <option value="menunggu di setujui">menunggu di setujui</option>
      </select></td>
    </tr>
			<tr>
				<td height="72">&nbsp;</td>
