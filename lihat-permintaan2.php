<html>
	<br /><p align="center"><b>Lihat Permintaan Barang</b></p><br>
	...
	<?php
  include "koneksi.php";
		$Cari="SELECT * FROM permintaan_barang ORDER BY tanggal";
	...
	?>
		...
		<tr align="center">
		    ...
		    <td bgcolor="#EEF2F7"><div align="center"><a href="home3.php?page=form-edit-permintaan2&code=<?=$code?>">SETUJU / TIDAK SETUJU</a>
			<td bgcolor="#EEF2F7"><div align="center"><a href="delete-permintaan.php?page=delete-permintaan&code=<?=$code?>" OnClick="return confirm('Yakin Data <?=$code?> akan dihapus?');">Delete</a>
			</div>
			</td>
			</tr>
		<tr align="center" bgcolor="#DFE6EF">
